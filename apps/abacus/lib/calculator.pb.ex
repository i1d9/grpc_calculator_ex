...
defmodule Abacus.Calculator.Service do
  ...
  rpc :Multiplication, Abacus.ArithmeticRequest, Abacus.ArithmeticReply

  rpc :Addition, Abacus.ArithmeticRequest, Abacus.ArithmeticReply

  rpc :Subtraction, Abacus.ArithmeticRequest, Abacus.ArithmeticReply

  rpc :Division, Abacus.ArithmeticRequest, Abacus.ArithmeticReply
end
